          ...
          <Card>
            <CardContent className="pt-6">
              <dl className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm sm:grid-cols-4">
                ...
                <div><dt className="text-gray-500">Total Fees</dt><dd className="font-bold text-blue-700">₹{totalFees.toLocaleString()}</dd></div>
                ...
                <table className="w-full min-w-[900px] text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="border-t-2 font-bold bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-blue-700">₹{totalFees.toLocaleString()}</td>
                    </tr>
                  </tbody>
                </table>
              )}
